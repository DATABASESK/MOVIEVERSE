...
export const getMcuMovies = async (page = 1) => {
  const apiKey = "6a716055bdc6e3d144a3d1777ef6fe59";
...
export const getRecentTamilMovies = async (page = 1) => {
  ...
  const url = `https://api.themoviedb.org/3/discover/movie?language=ta-IN&region=IN&with_original_language=ta&sort_by=release_date.desc&release_date.lte=${today}&with_watch_providers=${ottProviders.join(
    "|"
  )}&watch_region=IN&with_release_type=3|4&page=${page}&api_key=6a716055bdc6e3d144a3d1777ef6fe59`;
...
export const getTopNetflixSeriesGlobal = async (page = 1) => {
  ...
  const url = `https://api.themoviedb.org/3/discover/tv?sort_by=popularity.desc&first_air_date.lte=${today}&with_watch_providers=${netflixProvider}&watch_region=${watchRegion}&with_genres=${mysteryGenreId}&include_adult=true&page=${page}&api_key=6a716055bdc6e3d144a3d1777ef6fe59`;
...
export const getRomanticMovies = async (page) => {
    const url = `https://api.themoviedb.org/3/discover/movie?language=en-US&with_genres=10749&include_adult=true&sort_by=popularity.desc&page=${page}&api_key=6a716055bdc6e3d144a3d1777ef6fe59`;
...
export const getTamilTrendingMovies = async (page = 1) => {
  const url = `https://api.themoviedb.org/3/discover/movie?api_key=6a716055bdc6e3d144a3d1777ef6fe59&language=ta-IN&region=IN&sort_by=popularity.desc&page=${page}`;
...
export const getVijayMovies = async (page = 1) => {
  const url = `https://api.themoviedb.org/3/discover/movie?api_key=6a716055bdc6e3d144a3d1777ef6fe59&language=ta-IN&region=IN&sort_by=popularity.desc&with_cast=12246&page=${page}`;
...
export const getPopularMovies = async (page) => {
  const url = `https://api.themoviedb.org/3/movie/popular?language=en-US&page=${page}&api_key=6a716055bdc6e3d144a3d1777ef6fe59`;
...
export const getTopRatedMovies = async (page = 1) => {
  const url = `https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=${page}&api_key=6a716055bdc6e3d144a3d1777ef6fe59`;
